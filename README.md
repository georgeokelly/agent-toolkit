...
**Review workflow / Review 工作流**: The multi-model reviewer system (`.cursor/agents/`, `30-review-criteria.md`) is **Cursor-only** — it relies on Cursor's sub-agent Task architecture. Supported reviewer models include Claude 4.6 Opus Max, Kimi K2.5, GPT-5.4 series, Gemini 3.1 Pro, and Grok 4.20. / 多模型 reviewer 系统为 **Cursor 专属**。
